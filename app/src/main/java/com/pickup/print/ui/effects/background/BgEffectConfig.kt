...
internal object BgEffectConfig {
    ...
    private val TABLET_LIGHT = Config(
        points = floatArrayOf(0.8f, 0.2f, 1.0f, 0.8f, 0.9f, 1.0f, 0.2f, 0.9f, 1.0f, 0.2f, 0.2f, 1.0f),
    ...
    private val TABLET_DARK = Config(
        points = floatArrayOf(0.8f, 0.2f, 1.0f, 0.8f, 0.9f, 1.0f, 0.2f, 0.9f, 1.0f, 0.2f, 0.2f, 1.0f),
    ...
    internal fun get(isDark: Boolean, isTablet: Boolean): Config = when {
        isTablet && !isDark -> TABLET_LIGHT
        isTablet -> TABLET_DARK
        !isDark -> PHONE_LIGHT
        else -> PHONE_DARK
    }
}