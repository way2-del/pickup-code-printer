...
@Stable
class NavigationRailState(initialExpanded: Boolean = true) {
    var isExpanded: Boolean by mutableStateOf(initialExpanded)
}

@Composable
fun rememberNavigationRailState(initialExpanded: Boolean = true): NavigationRailState {
    return remember { NavigationRailState(initialExpanded) }
}
